...
const cmsg = $root.cmsg = (() => {
    ...
    cmsg.ReqLogin = (function() {
        ...
        ReqLogin.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.ReqLogin();
        ...
        ReqLogin.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.ReqLogin)
                return object;
            let message = new $root.cmsg.ReqLogin();
        ...
        ReqLogin.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/cmsg.ReqLogin";
        };
    ...
    cmsg.RespLogin = (function() {
         ...
         * @property {number|null} [userID] RespLogin userID
        ...
        RespLogin.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.RespLogin();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        RespLogin.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.RespLogin)
                return object;
            let message = new $root.cmsg.RespLogin();
            switch (object.err) {
            default:
        ...
        RespLogin.toObject = function toObject(message, options) {
            ...
            if (message.err != null && message.hasOwnProperty("err"))
                object.err = options.enums === String ? $root.cmsg.RespLogin.Error[message.err] === undefined ? message.err : $root.cmsg.RespLogin.Error[message.err] : message.err;
        ...
        RespLogin.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/cmsg.RespLogin";
        };
    ...
    cmsg.ReqJoinGame = (function() {
        ...
        ReqJoinGame.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.ReqJoinGame();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        ReqJoinGame.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.ReqJoinGame)
                return object;
            let message = new $root.cmsg.ReqJoinGame();
         ...
         * @returns {string} The default type url
         */
        ReqJoinGame.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.ReqJoinGame";
        };
    ...
    cmsg.RespJoinGame = (function() {
        ...
        RespJoinGame.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.RespJoinGame();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        RespJoinGame.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.RespJoinGame)
                return object;
            let message = new $root.cmsg.RespJoinGame();
            switch (object.err) {
            default:
                if (typeof object.err === "number") {
                    message.err = object.err;
        ...
        RespJoinGame.toObject = function toObject(message, options) {
            ...
            if (message.err != null && message.hasOwnProperty("err"))
                object.err = options.enums === String ? $root.cmsg.RespJoinGame.Error[message.err] === undefined ? message.err : $root.cmsg.RespJoinGame.Error[message.err] : message.err;
            if (message.nickname != null && message.hasOwnProperty("nickname"))
                object.nickname = message.nickname;
            return object;
        };
         ...
         * @returns {string} The default type url
         */
        RespJoinGame.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.RespJoinGame";
        };
    ...
    cmsg.ReqEnterGame = (function() {
        ...
        ReqEnterGame.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.ReqEnterGame();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                default:
         ...
         * @returns {string} The default type url
         */
        ReqEnterGame.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.ReqEnterGame";
        };
    ...
    cmsg.RespEnterGame = (function() {
        ...
        RespEnterGame.encode = function encode(message, writer) {
            ...
            if (message.gameLeftSec != null && Object.hasOwnProperty.call(message, "gameLeftSec"))
        ...
        RespEnterGame.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.RespEnterGame();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        RespEnterGame.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.RespEnterGame)
                return object;
            let message = new $root.cmsg.RespEnterGame();
        ...
        RespEnterGame.toObject = function toObject(message, options) {
            ...
            if (message.err != null && message.hasOwnProperty("err"))
                object.err = options.enums === String ? $root.cmsg.RespEnterGame.Error[message.err] === undefined ? message.err : $root.cmsg.RespEnterGame.Error[message.err] : message.err;
            return object;
        };
         ...
         * @returns {string} The default type url
         */
        RespEnterGame.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.RespEnterGame";
        };
        ...
        RespEnterGame.Config = (function() {
            ...
            Config.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.bulletLiveTime != null && Object.hasOwnProperty.call(message, "bulletLiveTime"))
                    writer.uint32(/* id 1, wireType 0 =*/8).int32(message.bulletLiveTime);
                if (message.rotationDelta != null && Object.hasOwnProperty.call(message, "rotationDelta"))
                    writer.uint32(/* id 2, wireType 5 =*/21).float(message.rotationDelta);
                if (message.entitySpeed != null && Object.hasOwnProperty.call(message, "entitySpeed"))
                    writer.uint32(/* id 3, wireType 0 =*/24).int32(message.entitySpeed);
                if (message.bulletSpeed != null && Object.hasOwnProperty.call(message, "bulletSpeed"))
                    writer.uint32(/* id 4, wireType 0 =*/32).int32(message.bulletSpeed);
                if (message.noticePosDuration != null && Object.hasOwnProperty.call(message, "noticePosDuration"))
                    writer.uint32(/* id 5, wireType 0 =*/40).int32(message.noticePosDuration);
                if (message.protectTime != null && Object.hasOwnProperty.call(message, "protectTime"))
                    writer.uint32(/* id 6, wireType 0 =*/48).int32(message.protectTime);
                if (message.entityRadius != null && Object.hasOwnProperty.call(message, "entityRadius"))
            ...
            Config.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.RespEnterGame.Config();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Config.fromObject = function fromObject(object) {
                if (object instanceof $root.cmsg.RespEnterGame.Config)
                    return object;
                let message = new $root.cmsg.RespEnterGame.Config();
            ...
            Config.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/cmsg.RespEnterGame.Config";
            };
    ...
    cmsg.Rank = (function() {
        ...
        Rank.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.Rank();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Rank.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.Rank)
                return object;
            let message = new $root.cmsg.Rank();
            if (object.list) {
        ...
        Rank.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/cmsg.Rank";
        };
        ...
        Rank.Item = (function() {
            ...
            Item.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.Rank.Item();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Item.fromObject = function fromObject(object) {
                if (object instanceof $root.cmsg.Rank.Item)
                    return object;
                let message = new $root.cmsg.Rank.Item();
                if (object.entityID != null)
                    message.entityID = object.entityID | 0;
            ...
            Item.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/cmsg.Rank.Item";
            };
    ...
    cmsg.SNoticeGameOver = (function() {
        ...
        SNoticeGameOver.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.overReason != null && Object.hasOwnProperty.call(message, "overReason"))
        ...
        SNoticeGameOver.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.SNoticeGameOver();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        SNoticeGameOver.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.SNoticeGameOver)
                return object;
            let message = new $root.cmsg.SNoticeGameOver();
         ...
         * @returns {string} The default type url
         */
        SNoticeGameOver.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.SNoticeGameOver";
        };
        ...
        SNoticeGameOver.Killer = (function() {
            ...
            Killer.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.SNoticeGameOver.Killer();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Killer.fromObject = function fromObject(object) {
                if (object instanceof $root.cmsg.SNoticeGameOver.Killer)
                    return object;
                let message = new $root.cmsg.SNoticeGameOver.Killer();
             ...
             * @returns {string} The default type url
             */
            Killer.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/cmsg.SNoticeGameOver.Killer";
            };
    ...
    cmsg.ReqMove = (function() {
        ...
        ReqMove.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.pressTime != null && Object.hasOwnProperty.call(message, "pressTime"))
                writer.uint32(/* id 1, wireType 5 =*/13).float(message.pressTime);
            if (message.targetRotation != null && Object.hasOwnProperty.call(message, "targetRotation"))
                writer.uint32(/* id 2, wireType 5 =*/21).float(message.targetRotation);
            if (message.inputSeqID != null && Object.hasOwnProperty.call(message, "inputSeqID"))
        ...
        ReqMove.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.ReqMove();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        ReqMove.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.ReqMove)
                return object;
            let message = new $root.cmsg.ReqMove();
         ...
         * @returns {string} The default type url
         */
        ReqMove.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.ReqMove";
        };
    ...
    cmsg.ReqShoot = (function() {
        ...
        ReqShoot.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.ReqShoot();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                default:
         ...
         * @returns {string} The default type url
         */
        ReqShoot.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.ReqShoot";
        };
    ...
    cmsg.ReqJump = (function() {
        ...
        ReqJump.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.ReqJump();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                default:
         ...
         * @returns {string} The default type url
         */
        ReqJump.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.ReqJump";
        };
    ...
    cmsg.ReqGameScene = (function() {
        ...
        ReqGameScene.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.ReqGameScene();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                default:
         ...
         * @returns {string} The default type url
         */
        ReqGameScene.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.ReqGameScene";
        };
    ...
    cmsg.RespGameScene = (function() {
        ...
        RespGameScene.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.RespGameScene();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        RespGameScene.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.RespGameScene)
                return object;
            let message = new $root.cmsg.RespGameScene();
            if (object.entities) {
        ...
        RespGameScene.toObject = function toObject(message, options) {
            ...
            if (message.gameLeftSec != null && message.hasOwnProperty("gameLeftSec"))
                object.gameLeftSec = message.gameLeftSec;
            if (message.err != null && message.hasOwnProperty("err"))
                object.err = options.enums === String ? $root.cmsg.RespGameScene.Error[message.err] === undefined ? message.err : $root.cmsg.RespGameScene.Error[message.err] : message.err;
            return object;
        };
         ...
         * @returns {string} The default type url
         */
        RespGameScene.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.RespGameScene";
        };
    ...
    cmsg.SNoticeShoot = (function() {
        ...
        SNoticeShoot.encode = function encode(message, writer) {
            ...
            if (message.creatorEntityID != null && Object.hasOwnProperty.call(message, "creatorEntityID"))
        ...
        SNoticeShoot.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.SNoticeShoot();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        SNoticeShoot.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.SNoticeShoot)
                return object;
            let message = new $root.cmsg.SNoticeShoot();
            if (object.x != null)
         ...
         * @returns {string} The default type url
         */
        SNoticeShoot.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.SNoticeShoot";
        };
    ...
    cmsg.SNoticeWorldChange = (function() {
        ...
        SNoticeWorldChange.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.SNoticeWorldChange();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        SNoticeWorldChange.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.SNoticeWorldChange)
                return object;
            let message = new $root.cmsg.SNoticeWorldChange();
            if (object.deleteBullets) {
                ...
                message.deleteBullets = [];
                for (let i = 0; i < object.deleteBullets.length; ++i)
            ...
            if (object.deleteEntities) {
                ...
                message.deleteEntities = [];
                for (let i = 0; i < object.deleteEntities.length; ++i)
            ...
            if (object.changedEntities) {
                ...
                message.changedEntities = [];
                for (let i = 0; i < object.changedEntities.length; ++i) {
        ...
        SNoticeWorldChange.toObject = function toObject(message, options) {
            ...
            if (message.deleteBullets && message.deleteBullets.length) {
                object.deleteBullets = [];
                for (let j = 0; j < message.deleteBullets.length; ++j)
                    object.deleteBullets[j] = message.deleteBullets[j];
            }
            if (message.deleteEntities && message.deleteEntities.length) {
                object.deleteEntities = [];
                for (let j = 0; j < message.deleteEntities.length; ++j)
                    object.deleteEntities[j] = message.deleteEntities[j];
            }
            if (message.changedEntities && message.changedEntities.length) {
                object.changedEntities = [];
                for (let j = 0; j < message.changedEntities.length; ++j)
         ...
         * @returns {string} The default type url
         */
        SNoticeWorldChange.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.SNoticeWorldChange";
        };
        ...
        SNoticeWorldChange.Entity = (function() {
            ...
            Entity.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.SNoticeWorldChange.Entity();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Entity.fromObject = function fromObject(object) {
                if (object instanceof $root.cmsg.SNoticeWorldChange.Entity)
                    return object;
                let message = new $root.cmsg.SNoticeWorldChange.Entity();
                if (object.id != null)
            ...
            Entity.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/cmsg.SNoticeWorldChange.Entity";
            };
    ...
    cmsg.SNoticeWorldPos = (function() {
        ...
        SNoticeWorldPos.encode = function encode(message, writer) {
            ...
            if (message.lastProcessedInputID != null && Object.hasOwnProperty.call(message, "lastProcessedInputID"))
        ...
        SNoticeWorldPos.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.SNoticeWorldPos();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        SNoticeWorldPos.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.SNoticeWorldPos)
                return object;
            let message = new $root.cmsg.SNoticeWorldPos();
            if (object.entities) {
                if (!Array.isArray(object.entities))
         ...
         * @returns {string} The default type url
         */
        SNoticeWorldPos.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.SNoticeWorldPos";
        };
        ...
        SNoticeWorldPos.Entity = (function() {
            ...
            Entity.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.SNoticeWorldPos.Entity();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            Entity.fromObject = function fromObject(object) {
                if (object instanceof $root.cmsg.SNoticeWorldPos.Entity)
                    return object;
                let message = new $root.cmsg.SNoticeWorldPos.Entity();
                if (object.id != null)
                    message.id = object.id | 0;
                if (object.x != null)
                    message.x = Number(object.x);
            ...
            Entity.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/cmsg.SNoticeWorldPos.Entity";
            };
    ...
    cmsg.Entity = (function() {
        ...
        Entity.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.Entity();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Entity.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.Entity)
                return object;
            let message = new $root.cmsg.Entity();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.accountType != null)
                message.accountType = object.accountType | 0;
        ...
        Entity.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/cmsg.Entity";
        };
    ...
    cmsg.SNoticeNewEntity = (function() {
        ...
        SNoticeNewEntity.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.SNoticeNewEntity();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        SNoticeNewEntity.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.SNoticeNewEntity)
                return object;
            let message = new $root.cmsg.SNoticeNewEntity();
         ...
         * @returns {string} The default type url
         */
        SNoticeNewEntity.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.SNoticeNewEntity";
        };
    ...
    cmsg.SNoticeKickOut = (function() {
        ...
        SNoticeKickOut.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.cmsg.SNoticeKickOut();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        SNoticeKickOut.fromObject = function fromObject(object) {
            if (object instanceof $root.cmsg.SNoticeKickOut)
                return object;
            let message = new $root.cmsg.SNoticeKickOut();
        ...
        SNoticeKickOut.toObject = function toObject(message, options) {
            ...
            if (message.reason != null && message.hasOwnProperty("reason"))
                object.reason = options.enums === String ? $root.cmsg.SNoticeKickOut.Reason[message.reason] === undefined ? message.reason : $root.cmsg.SNoticeKickOut.Reason[message.reason] : message.reason;
            return object;
        };
         ...
         * @returns {string} The default type url
         */
        SNoticeKickOut.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/cmsg.SNoticeKickOut";
        };
